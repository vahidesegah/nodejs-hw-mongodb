...
const googleOAuthClient = new OAuth2Client({
  clientId: process.env[`GOOGLE_AUTH_CLIENT_ID`], // çevresel değişkenleri değiştiriyoruz
  clientSecret: process.env[`GOOGLE_AUTH_CLIENT_SECRET`], // çevresel değişkenleri değiştiriyoruz
